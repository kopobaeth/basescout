...
export function normalizeGoPlusSecurityResponse(value: unknown, tokenAddress: string): SecurityIntelligence {
  ...
  const tradingRestriction = flagValue(tokenRecord, [
    "trading_cooldown",
  ...
  checks.push(
    transferTax === undefined
      ...
      : finding(
          ...
          `Transfer tax: ${percentText(transferTax)}`,
          transferTax > 10
